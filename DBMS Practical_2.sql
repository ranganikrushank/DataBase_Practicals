...
create table tblStudent (studentID int primary key, fName varchar(20),
...
insert into tblStudent value("001","Parth","Mohon","Patel","Surat","Gujarat","India","1991-06-25","Male","101256","CO","2006"),
...
select count(studentID) from tblStudent;
select count(fname) from tblStudent;
select count(*) from tblStudent where fname is not null;
select count(studentID) from tblStudent where fname is null;



select count(*) from tblStudent where studentID>2;
select count(studentID) from tblStudent where studentID>2;


select count(*) from tblStudent where "Aatul"<fname and studentID>2;
select count(*) from tblStudent where "Aatul"<fname or studentID>2;
select count(fname) from tblStudent where "Aatul"<fname and studentID>2;
select count(studentID) from tblStudent where "Aatul"<fname or studentID>2;
